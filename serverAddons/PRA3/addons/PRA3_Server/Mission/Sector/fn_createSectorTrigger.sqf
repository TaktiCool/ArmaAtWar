...
if (hasInterface) then {
    ...
    if (isNull _trig) then {
        ...
        _trig setTriggerStatements ["this", format ["['sector_entered','%1'] call PRA3_Core_fnc_localEvent;",_marker], format ["['sector_leaved','%1'] call PRA3_Core_fnc_localEvent;",_marker]];
