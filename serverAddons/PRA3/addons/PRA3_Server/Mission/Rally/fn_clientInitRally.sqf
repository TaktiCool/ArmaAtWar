...
GVAR(rallyArray) = [_minDistance, _spawnCount, _sides, _nearPlayerToBuild];
...
[
    ...
    PRA3_Player,
    0,
    //["_uid", "_fnc", "_args", "_duration", "_event"];
    {PRA3_Player == leader PRA3_Player && [QFUNC(isRallyPlaceable), FUNC(isRallyPlaceable), [PRA3_Player], 5, QGVAR(ClearRallyPlacable)] call CFUNC(cachedCall)},
    {
