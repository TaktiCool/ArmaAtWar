...
["Create Rally Point", PRA3_Player, 0, {
    ...
    [{
        ...
        ["displayNotification", group PRA3_Player, [format["Your Team Leader Placed a Rally Near %1", [getPos PRA3_Player] call CFUNC(getNearestLocationName)]]] call CFUNC(targetEvent);
