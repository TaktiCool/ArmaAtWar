...
DFUNC(drawSector) = {
    ...
    _icon pushBack ["ICON", _backgroundIconPath, _color, _position, 70/18, 35/18, 0, "", _shadow, pixelH*20, "RobotoCondensedBold", "center", false, _fncScaleIcon];
    _icon pushBack ["ICON", "", [1, 1, 1, 1], _position, 70/18, 35/18, 0, _fullname, 2, pixelH*24, "RobotoCondensedBold", "center", false, _fncScaleIcon];
    reverse _icon;
