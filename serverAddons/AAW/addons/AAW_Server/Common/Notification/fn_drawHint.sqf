...
_grp ctrlSetPosition [safeZoneX+ safeZoneW/4 + (_offset select 0), safeZoneY + safeZoneH/5 + (_offset select 1), safeZoneW/2, 0];
_grp ctrlSetFade 1;
_grp ctrlCommit 0;
...
_grp ctrlSetFade 0;
_grp ctrlSetPosition [safeZoneX+ safeZoneW/4 + (_offset select 0), safeZoneY + safeZoneH/5 + (_offset select 1), safeZoneW/2,  PY(20)];
_grp ctrlCommit 0.2;
