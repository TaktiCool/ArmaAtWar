    ...
    class Controls {
        class MySquad : RscControlsGroupNoScrollbars {
            ...
            class Controls {
                ...
                class ListEntry0 : RscControlsGroupNoScrollbars {
                    ...
                    w = PX(35);
                    h = PY(4);
                    onMouseMoving = "['AAW_UI_RespawnScreen_SquadMemberListEntry_onMouseMoving', _this] call CLib_fnc_localEvent;";
                    class Controls {
        ...
        */
        ...
        class BtnShowSquadList : BtnWhite {
            ...
            colorText[] = {1,1,1,1};
            onButtonClick = "'AAW_UI_RespawnScreen_BtnShowSquadList_onButtonClick' call CLib_fnc_localEvent;";
        };
        ...
        class SquadList : RscControlsGroup {
            ...
            class Controls {
                ...
                class ListEntry0 : RscControlsGroupNoScrollbars {
                    ...
                    w = PX(35);
                    h = PY(4);
                    onMouseMoving = "['AAW_UI_RespawnScreen_SquadListEntry_onMouseMoving', _this] call CLib_fnc_localEvent;";
                    class Controls {
