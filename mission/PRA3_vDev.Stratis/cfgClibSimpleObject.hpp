class CfgCLibSimpleObject {
    ...
    class FOBNATO {
        ...
        class item0 {
			 ...
			 offset[] = {-0.262329, 0.00878906, 5.8253};
			 dirVector[] = {0, 1, 0};
			 upVector[] = {0, 0, 1};
		};
		class item1 {
			 path = "a3\structures_f\items\electronics\satellitephone_f.p3d";
			 offset[] = {-0.114258, -0.241211, 6.81547};
