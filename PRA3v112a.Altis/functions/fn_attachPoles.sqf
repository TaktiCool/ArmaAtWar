...
ob1 setFlagTexture 'media\prlogoBLUFOR.jpg'; ob1 setVariable ["R3F_LOG_disabled", true]; ob1 allowDamage false; [blufactory, west] execVM "scripts\arsenalFARP.sqf";
ob7 setFlagTexture 'media\prlogoOPFOR.jpg'; ob7 setVariable ["R3F_LOG_disabled", true]; ob7 allowDamage false; [opfactory, east] execVM "scripts\arsenalFARP.sqf";
